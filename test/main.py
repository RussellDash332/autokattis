...
print(df:=ret.to_df())
df.to_csv('test_problems_no_partial.csv', index=False)
...
print(df:=ret.to_df())
df.to_csv('test_list_unsolved.csv', index=False)
...
print(df:=ret.to_df())
df.to_csv('test_suggest.csv', index=False)
