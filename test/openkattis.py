...
test('open_university_ranklist_top100',     kt.university_ranklist, {})
test('open_university_ranklist_specific_1', kt.university_ranklist, {'value': 'nus.edu.sg'})
test('open_university_ranklist_specific_2', kt.university_ranklist, {'value': 'National University of Singapore'})
test('open_university_ranklist_specific_3', kt.university_ranklist, {'value': 'ru.is'})
